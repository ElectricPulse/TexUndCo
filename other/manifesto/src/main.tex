...
\author{Adam Jozef Labuš}

\begin{document}
\maketitle

\section Úvod
	- táto kniha nie je výhovorka pre neochotu sa učiť pre študentov, ktorý sa vyhýbajú vzdelaniu - do určitej miery by to vzdelanie malo byť povinné %TODO: ku tomuto urobit diskusiu
...
Škriatok je teda zdroj problémov v školskom systéme.
Zbavíte sa záujmu moci v školstve a zostávajúci záujem vzdelávať by mal spôsobiť, že eventuélne všetky mňou opísané problémy sa opravia sami.
Teda problémy, ktoré budem opisovať a množstvo koľko ich je, je len argumentácia, pre to, že nejaká systémová a to záujmová chyba v školstve existuje.
To znamená, že keď v akéjkoľvek časti sekcií problémy uznáte, že tak naozaj je, tak kludne preskočte na koniec knihy do sekcií riešení. 
% TODO: Postupne dopisuj jeden predmet za druhym
\section Problémy
	V tejto sekcí sa budem snažiť rozpísať jednotlivé problémy v školstve s sústredením čo na najvačiu konkrétnosť, tak aby každý mohol uznať, ich validitu,
	pričom každý z nich by sa dal rozpísať na osobitnú knihu, preto sa budem niekedy vyhýbať detailom.
	Budem ich opisovať od najzávažnejšie po najmenej závažné.
...
\section Riešenia
Obvyňovať sa medzi sebou kto vlastne ten škriatok je, nikomu nepomôže.
Je možné, že najväčšia časť tohto škriatka sa nachádza už len v legislatíve a financiach.
V diktatúrach je takíto škriatko samozrejme aj v politike (Rusko).
V pokročilých demokraciach je to fakt len v tej legislatíve (Nemecko).
\end{document}
