...
\begin{document}
	...
	\begin{frame}
		...
		\only<2>{\includegraphics[width=\textwidth]{day2/poprad-polovica}}
		\only<3->{\includegraphics[width=\textwidth]{day2/poprad}}
	...
	\begin{frame}
		...
		\only<1>{\includegraphics[width=\textwidth]{day3/stanica}}
		\only<2>{\includegraphics[width=\textwidth]{day3/mapa}}
		\only<3-5>{
			\begin{columns}
				\begin{column}{0.5\textwidth}
				Štrbské pleso
				...
				\only<4>{
				Very good market
				\includegraphics[width=\textwidth]{day3/trhy}
				}
				\only<5>{
				Popradské pleso
		...
		\only<6>{\includegraphics[width=\textwidth]{day3/zubacka}}
		\only<7>{\includegraphics[width=\textwidth]{day3/back}}
	\end{frame}
	...
	\begin{frame}
		...
		\includegraphics[width=\textwidth]{day5/jaskyna}
	\end{frame}
